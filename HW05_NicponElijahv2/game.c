    ...
    for (int i = 0; i < NUMPOOKAHS; i++) {
        ...
        if (pookahs[i].active && pookahs[i].damage == 0) {
            ...
            if (pookahs[i].x < 0 || pookahs[i].x > 224 || 
                ...
                // gameTileMap[OFFSET(((pookahs[i].x - pookahs[i].dx)/8) + 0, ((pookahs[i].y)/8) - 1, 32)] = 4;
                // gameTileMap[OFFSET(((pookahs[i].x - pookahs[i].dx)/8) + 1, ((pookahs[i].y)/8) - 1, 32)] = 4;
                // gameTileMap[OFFSET(((pookahs[i].x - pookahs[i].dx)/8) + 2, ((pookahs[i].y)/8) - 1, 32)] = 4;

                if (gameTileMap[OFFSET(((pookahs[i].x - pookahs[i].dx)/8) + 0, ((pookahs[i].y)/8) - 1, 32)] == 0 &&
                gameTileMap[OFFSET(((pookahs[i].x - pookahs[i].dx)/8) + 1, ((pookahs[i].y)/8) - 1, 32)] == 0 &&
                gameTileMap[OFFSET(((pookahs[i].x - pookahs[i].dx)/8) + 2, ((pookahs[i].y)/8) - 1, 32)] == 0) {
                    pookahs[i].dy = 1;
                ...
                // if (gameTileMap[OFFSET(((pookahs[i].x + pookahs[i].dx)/8), ((pookahs[i].y)/8) - 1, 32)] == 0 && 
                //     gameTileMap[OFFSET(((pookahs[i].x + pookahs[i].dx)/8) + 1, ((pookahs[i].y)/8) - 1, 32)] == 0) {
                //         pookahs[i].dy = -1;
                //         pookahs[i].dx = 0;
                //         //pookahs[i].x = ((pookahs[i].x / 8) + 1) * 8;
                // } else {
                //     pookahs[i].dx *= -1;
                // }
            }
            ...
            if (pookahs[i].y < 8 || pookahs[i].y > 136 ||
                ...
                // gameTileMap[OFFSET(((pookahs[i].x)/8)-1, (pookahs[i].y)/8, 32)] =5;
                // gameTileMap[OFFSET(((pookahs[i].x)/8)-1, ((pookahs[i].y)/8)+1, 32)] =5; 
                // gameTileMap[OFFSET(((pookahs[i].x)/8)-1, ((pookahs[i].y)/8)+2, 32)] =5; 

                if (gameTileMap[OFFSET(((pookahs[i].x)/8)-1, (pookahs[i].y)/8, 32)] == 0 &&
                gameTileMap[OFFSET(((pookahs[i].x)/8)-1, ((pookahs[i].y)/8)+1, 32)] == 0 && 
                gameTileMap[OFFSET(((pookahs[i].x)/8)-1, ((pookahs[i].y)/8)+2, 32)] == 0) {
                    pookahs[i].dx = 1;
